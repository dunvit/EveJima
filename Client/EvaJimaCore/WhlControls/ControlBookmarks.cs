...
{
    public partial class ControlBookmarks : BaseContainer
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(ControlBookmarks));

        public ControlBookmarks()
        {
            InitializeComponent();

            cmdPasteLocationBookmarks.Value = Localization.Messages.Get("Tab_Bookmarks_PasteLocationBookmarks");
            cmdPasteCosmicSifnatures.Value = Localization.Messages.Get("Tab_Bookmarks_PasteCosmicSignatures");
            cmdClearLists.Value = Localization.Messages.Get("Tab_Bookmarks_Clear");
            cmdClear.Value = Localization.Messages.Get("Tab_Bookmarks_Analyze");
        }
