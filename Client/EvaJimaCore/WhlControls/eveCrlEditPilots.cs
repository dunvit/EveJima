...
{
    public partial class eveCrlEditPilots : BaseContainer
    {
        ...
        public eveCrlEditPilots()
        {
            InitializeComponent();

            cmdReturn.Value = Global.Messages.Get("Tab_EditPilots_Return");
            cmdDelete.Value = Global.Messages.Get("Tab_EditPilots_Delete");
            cmdSaveChanges.Value = Global.Messages.Get("Tab_EditPilots_Save");
            lblNeedRestart.Text = Global.Messages.Get("Tab_EditPilots_Message_NeedRestart");
            lblAfterDeleteNotification.Text = Global.Messages.Get("Tab_EditPilots_Message_AfterDelete");
