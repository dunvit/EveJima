...
{
    public partial class ControlTravelHistory : BaseContainer
    {
        ...
        public ControlTravelHistory()
        {
            InitializeComponent();

            cmdExecute.Value = Localization.Messages.Get("Tab_TravelHistory_ShowNewSignatures");
            txtNewSignaturesLabel.Text = Localization.Messages.Get("Tab_TravelHistory_NewSignaturesLabel");
            lblHelp.Text = Localization.Messages.Get("Tab_TravelHistory_Help");
