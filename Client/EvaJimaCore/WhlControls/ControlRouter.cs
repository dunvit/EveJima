...
{
    public partial class ControlRouter : BaseContainer
    {
        ...
        public ControlRouter()
        {
            ...
            label3.Text = Localization.Messages.Get("Tab_Router_CreateRoute");
            cmdStartRoute.Text = Localization.Messages.Get("Tab_Router_SetDestination");
            ejButton1.Text = Localization.Messages.Get("Tab_Router_LoadFromFile");
        }
