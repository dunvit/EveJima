...
namespace Server.Tools
{
    public class SqlComm
    {
        ...
        private static string DatabaseConnectionString = "Data Source=evejimadb.mssql.somee.com;Initial Catalog=evejimadb;Persist Security Info=True;User ID=evajima-storage_SQLLogin_1;Password=12341234";
